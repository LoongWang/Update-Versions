...
cd "/home/odroid/catkin_ws/src/rosserial/rosserial_client"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/odroid/catkin_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/odroid/catkin_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
