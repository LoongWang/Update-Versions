#define DEPTH_ST_1 0.45
#define THRUST_ST_2 -40
#define THRUST_ST_4 -50
#define THRUST_ST_5 -60
...
int main(int argc, char **argv)
{
  ...
  nh.param("SetupTime",getval,200.0);
  setup_time = getval/2;

  nh.param("TimeOut",getval,1000.0);
  time_out = getval/2;
 ...
 if(KS == "STOP!") { ros::shutdown(); }
...

    {
      ...
      case 2:
         ...
         if ((int)time_since_go > setup_time ) 
         {
